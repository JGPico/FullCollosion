...
var speed = 4;
var colors = ['#408AFF', '#3AE89A', '#C7FF4D', '#E8B33A', '#FF4F29']; // Event Listeners
...
var Particle = /*#__PURE__*/function () {
  ...
  _createClass(Particle, [{
    ...
    value: function update(particles) {
      ...
      if (_utils__WEBPACK_IMPORTED_MODULE_0___default.a.distance(mouse.x, mouse.y, this.x, this.y) < 120 && this.opacity < 0.2) {
        this.opacity += 0.02;
